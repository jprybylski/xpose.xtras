...
Load [`library(xpose)`](https://uupharmacometrics.github.io/xpose/)
before
[`library(xpose.xtras)`](https://jprybylski.github.io/xpose.xtras/) so
these bugfixes take effect via normal masking. If you use
...
(e.g. [`conflicted::conflicts_prefer()`](https://conflicted.r-lib.org/reference/conflicts_prefer.html)).
...
![](reference/figures/README-eta_vs-2.png)
...
![](reference/figures/README-shark-1.png)
