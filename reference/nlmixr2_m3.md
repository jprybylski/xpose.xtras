...
A modified version of the theophylline model fit with censoring added in
to provoke M3 censoring. An additional output variable is added to use
an an example in categorical DVs.
...
An object of class `xp_xtras` (inherits from `xpose_data`, `uneval`) of
length 10.
...
[xpdb_nlmixr2](https://jprybylski.github.io/xpose.xtras/reference/xpdb_nlmixr2.md)
