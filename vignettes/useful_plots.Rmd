...
The more common needs for an `xpose_set` include model-building tables, covariate testing and visualization. However, there are occassions where a visual description of what can be shown in these tables can be useful.
